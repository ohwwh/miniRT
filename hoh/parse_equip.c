...
t_light	*alloc_light(t_object *sc)
{
	t_light	*new_light;
...
void	parse_ambient(t_object *sc, char **tokens)
{
...
void	parse_camera(t_object *sc, char **tokens)
{
...
void	parse_light(t_object *sc, char **tokens)
{
	t_light	*new;
